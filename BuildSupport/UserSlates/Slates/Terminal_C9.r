...
resource restype_Slate (resid_Git, "") { {
	Slate { "Git",	{
		...
		Event { "get merge message", "" },	Sequence{}, TypeText { "print -n \"issueNumber: \"; read issueNumber; mm=$(${CCDev}/bin/python/scm.py \"${cb}\" $issueNumber); print \"$mm\"" }, Keypress { kc_enter, 0 }, ResSubslate { resid_gitType }, endSequence{},
