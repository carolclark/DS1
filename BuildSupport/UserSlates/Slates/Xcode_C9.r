...
resource restype_Slate (resid_ProjectSettings, "Project") { {
	Slate { "projSettings", {
		...
		Event { "install target", "" },			Subslate { "installTarget" },
			_SlateGlobals_,
			_CloseSubslate_,
			Event { "build script", "" },			TypeText { "${TARGET_NAME}/${TARGET_NAME}_install.ksh" },
			Event { "arguments", "" },				TypeText { "\"${SRCROOT}\" ${TARGET_NAME} $(ACTION)" },
			endSubslate{},
		_SlateGlobals_,
		_IMouseSlate_,
		_DirectionKeys_,
