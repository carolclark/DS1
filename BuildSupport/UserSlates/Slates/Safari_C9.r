// =================================================================================
//	Safari.r					(c)2005-13 C & C Software, Inc. All rights reserved.
// =================================================================================
...
resource restype_Slate (resid_TypeSafariSlate, "Type Slate") { {
	Slate { "Type",	{
		...
		Event { "functions", "click the Functions menu" },
			Click { 1, 60, 35, _window, _topLeft },
...
#define _SafariStandards_	\
		...
		Event { "inhouse link", "" },	Sequence{},	\
			...
			endSequence{},	\
		Event { "main frame", "" },	Click { 1, 0, 0, _window, _centerCenter },	\
		Event { "left edge", "" },	Click { 1, 3, 350, _window, _topLeft },	\
...
resource restype_Slate (resid_loLeftIndex, "LeftIndex") { {
	Slate { "LeftIndex",	{
		...
		Event { "one", "" },			Click { 0, LINDX_left, LINDX_top + 0 * LINDX_rsp, _window, _topLeft },
		Event { "two", "" },			Click { 0, LINDX_left, LINDX_top + 1 * LINDX_rsp, _window, _topLeft },
		Event { "three", "" },			Click { 0, LINDX_left, LINDX_top + 2 * LINDX_rsp, _window, _topLeft },
		Event { "four", "" },			Click { 0, LINDX_left, LINDX_top + 3 * LINDX_rsp, _window, _topLeft },
		Event { "five", "" },			Click { 0, LINDX_left, LINDX_top + 4 * LINDX_rsp, _window, _topLeft },
		Event { "six", "" },			Click { 0, LINDX_left, LINDX_top + 5 * LINDX_rsp, _window, _topLeft },
		Event { "seven", "" },			Click { 0, LINDX_left, LINDX_top + 6 * LINDX_rsp, _window, _topLeft },
		Event { "eight", "" },			Click { 0, LINDX_left, LINDX_top + 7 * LINDX_rsp, _window, _topLeft },
		Event { "nine", "" },			Click { 0, LINDX_left, LINDX_top + 8 * LINDX_rsp, _window, _topLeft },
		Event { "ten", "" },			Click { 0, LINDX_left, LINDX_top + 9 * LINDX_rsp, _window, _topLeft },
		Event { "eleven", "" },			Click { 0, LINDX_left, LINDX_top + 10 * LINDX_rsp, _window, _topLeft },
		Event { "twelve", "" },			Click { 0, LINDX_left, LINDX_top + 11 * LINDX_rsp, _window, _topLeft },
		Event { "thirteen", "" },		Click { 0, LINDX_left, LINDX_top + 12 * LINDX_rsp, _window, _topLeft },
		Event { "fourteen", "" },		Click { 0, LINDX_left, LINDX_top + 13 * LINDX_rsp, _window, _topLeft },
		Event { "fifteen", "" },		Click { 0, LINDX_left, LINDX_top + 14 * LINDX_rsp, _window, _topLeft },
		Event { "sixteen", "" },		Click { 0, LINDX_left, LINDX_top + 15 * LINDX_rsp, _window, _topLeft },
		Event { "seventeen", "" },		Click { 0, LINDX_left, LINDX_top + 16 * LINDX_rsp, _window, _topLeft },
		Event { "eighteen", "" },		Click { 0, LINDX_left, LINDX_top + 17 * LINDX_rsp, _window, _topLeft },
		Event { "nineteen", "" },		Click { 0, LINDX_left, LINDX_top + 18 * LINDX_rsp, _window, _topLeft },
		Event { "twenty", "" },			Click { 0, LINDX_left, LINDX_top + 19 * LINDX_rsp, _window, _topLeft },
	} }
} };
...
resource restype_Slate (resid_loAppleTopics, "AppleTopics Layout") { {
	Slate { "AppleTopics",	{
		...
		Event { "alpha", "" },			Click { 0, TOPC_left + 0 * TOPC_csp, TOPC_top, _window, _topLeft },
		Event { "bravo", "" },			Click { 0, TOPC_left + 1 * TOPC_csp, TOPC_top, _window, _topLeft },
		Event { "charlie", "" },		Click { 0, TOPC_left + 2 * TOPC_csp, TOPC_top, _window, _topLeft },
...
resource restype_Slate (resid_loAppleContent, "AppleContent Layout") { {
	Slate { "AppleContent",	{
		_SafariStandards_,
		_CloseSubslate_,
		Event { "next page", "" },				Click { 0, -56, 224, _window, _topRight },
		Event { "previous page", "" },			Click { 0, -116, 224, _window, _topRight },
		Event { "advanced search", "" },		Click { 0, -150, 150, _window, _topRight },
		...
		Event { "parent", "go up to parent" },	Subslate { "parent" },
			_SlateGlobals_,
			_CloseSubslate_,
			Event { "one", "" },					Click { 0, 240, 200, _window, _topLeft },
			Event { "two", "" },					Click { 0, 330, 200, _window, _topLeft },
			Event { "three", "" },					Click { 0, 420, 200, _window, _topLeft },
			Event { "four", "" },					Click { 0, 510, 200, _window, _topLeft },
			Event { "five", "" },					Click { 0, 600, 200, _window, _topLeft },
			Event { "six", "" },					Click { 0, 690, 200, _window, _topLeft },
			Event { "seven", "" },					Click { 0, 780, 200, _window, _topLeft },
			Event { "eight", "" },					Click { 0, 870, 200, _window, _topLeft },
			Event { "north", "" },					Click { 0, 0, -12, _cursor },
			Event { "down", "" },					Click { 0, 0, 12, _cursor },
			Event { "left", "" },					Click { 0, -40, 0, _cursor },
			Event { "right", "" },					Click { 0, 40, 0, _cursor },
...
resource restype_Slate (resid_loDocumentList, "DocumentList Layout") { {
	Slate { "DocumentList",	{
		...
		ExitEvent { "select", "" },		IMouse { im_Click, 1 },
		Event { "click one", ""	},		IMouse { im_Click, 1 },
		Event { "sort by title", "" },	Click { 0, 225, 560, _window, _topLeft },
		Event { "sort by name", "" },	Click { 0, 575, 560, _window, _topLeft },
		...
		Event { "one", "" },			Click { 0, DLIST_left, DLIST_top + 0 * DLIST_rsp, _window, _topLeft },
		Event { "two", "" },			Click { 0, DLIST_left, DLIST_top + 1 * DLIST_rsp, _window, _topLeft },
		Event { "three", "" },			Click { 0, DLIST_left, DLIST_top + 2 * DLIST_rsp, _window, _topLeft },
		Event { "four", "" },			Click { 0, DLIST_left, DLIST_top + 3 * DLIST_rsp, _window, _topLeft },
		Event { "five", "" },			Click { 0, DLIST_left, DLIST_top + 4 * DLIST_rsp, _window, _topLeft },
		Event { "six", "" },			Click { 0, DLIST_left, DLIST_top + 5 * DLIST_rsp, _window, _topLeft },
		Event { "seven", "" },			Click { 0, DLIST_left, DLIST_top + 6 * DLIST_rsp, _window, _topLeft },
		Event { "eight", "" },			Click { 0, DLIST_left, DLIST_top + 7 * DLIST_rsp, _window, _topLeft },
		Event { "nine", "" },			Click { 0, DLIST_left, DLIST_top + 8 * DLIST_rsp, _window, _topLeft },
		Event { "ten", "" },			Click { 0, DLIST_left, DLIST_top + 9 * DLIST_rsp, _window, _topLeft },
		Event { "eleven", "" },			Click { 0, DLIST_left, DLIST_top + 10 * DLIST_rsp, _window, _topLeft },
		Event { "twelve", "" },			Click { 0, DLIST_left, DLIST_top + 11 * DLIST_rsp, _window, _topLeft },
		Event { "thirteen", "" },		Click { 0, DLIST_left, DLIST_top + 12 * DLIST_rsp, _window, _topLeft },
		Event { "fourteen", "" },		Click { 0, DLIST_left, DLIST_top + 13 * DLIST_rsp, _window, _topLeft },
		Event { "fifteen", "" },		Click { 0, DLIST_left, DLIST_top + 14 * DLIST_rsp, _window, _topLeft },
		Event { "sixteen", "" },		Click { 0, DLIST_left, DLIST_top + 15 * DLIST_rsp, _window, _topLeft },
		Event { "seventeen", "" },		Click { 0, DLIST_left, DLIST_top + 16 * DLIST_rsp, _window, _topLeft },
		Event { "eighteen", "" },		Click { 0, DLIST_left, DLIST_top + 17 * DLIST_rsp, _window, _topLeft },
		Event { "nineteen", "" },		Click { 0, DLIST_left, DLIST_top + 18 * DLIST_rsp, _window, _topLeft },
		Event { "twenty", "" },			Click { 0, DLIST_left, DLIST_top + 19 * DLIST_rsp, _window, _topLeft },
	} }
} };
...
resource restype_Slate (resid_loAppleResults, "AppleResults Layout") { {
	Slate { "AppleResults",	{
		_SafariStandards_,
		_CloseSubslate_,
		Event { "advanced search", "" },Click { 0, 380, 332, _window, _topLeft },
		Event { "display", "" },		Click { 0, 630, 360, _window, _topLeft },
		Event { "previous", "" },		Click { 0, 700, 524, _window, _topLeft },
		Event { "next", "" },			Click { 0, 750, 524, _window, _topLeft },
		Event { "click one", ""	},		IMouse { im_Click, 1 },
		...
		Event { "one", "" },			Click { 0, APPRES_left, APPRES_top + 0 * APPRES_rsp, _window, _topLeft },
		Event { "two", "" },			Click { 0, APPRES_left, APPRES_top + 1 * APPRES_rsp, _window, _topLeft },
		Event { "three", "" },			Click { 0, APPRES_left, APPRES_top + 2 * APPRES_rsp, _window, _topLeft },
		Event { "four", "" },			Click { 0, APPRES_left, APPRES_top + 3 * APPRES_rsp, _window, _topLeft },
		Event { "five", "" },			Click { 0, APPRES_left, APPRES_top + 4 * APPRES_rsp, _window, _topLeft },
		Event { "six", "" },			Click { 0, APPRES_left, APPRES_top + 5 * APPRES_rsp, _window, _topLeft },
		Event { "seven", "" },			Click { 0, APPRES_left, APPRES_top + 6 * APPRES_rsp, _window, _topLeft },
		Event { "eight", "" },			Click { 0, APPRES_left, APPRES_top + 7 * APPRES_rsp, _window, _topLeft },
		Event { "nine", "" },			Click { 0, APPRES_left, APPRES_top + 8 * APPRES_rsp, _window, _topLeft },
		Event { "ten", "" },			Click { 0, APPRES_left, APPRES_top + 9 * APPRES_rsp, _window, _topLeft },
		Event { "eleven", "" },			Click { 0, APPRES_left, APPRES_top + 10 * APPRES_rsp, _window, _topLeft },
		Event { "twelve", "" },			Click { 0, APPRES_left, APPRES_top + 11 * APPRES_rsp, _window, _topLeft },
		Event { "thirteen", "" },		Click { 0, APPRES_left, APPRES_top + 12 * APPRES_rsp, _window, _topLeft },
		Event { "fourteen", "" },		Click { 0, APPRES_left, APPRES_top + 13 * APPRES_rsp, _window, _topLeft },
		Event { "fifteen", "" },		Click { 0, APPRES_left, APPRES_top + 14 * APPRES_rsp, _window, _topLeft },
		Event { "sixteen", "" },		Click { 0, APPRES_left, APPRES_top + 15 * APPRES_rsp, _window, _topLeft },
	} }
} };
...
resource restype_Slate (resid_Arbonne, "Arbonne Slate") { {
	Slate { "Arbonne",	{
		...
		Event { "Home", "" },				Sequence{}, ResSubslate { resid_arbHome }, Click { 1, -420, 100, _window, _topRight }, endSequence{},
		Event { "Shopping", "" },			Sequence{}, ResSubslate { resid_arbShop }, Click { 1, -170, 100, _window, _topRight }, endSequence{},
		Event { "Web Stats", "" },			Sequence{}, ResSubslate { resid_arbWebStats }, Click { 1, -250, 100, _window, _topRight }, endSequence{},
	 } }
} };
...
resource restype_Slate (resid_arbShopSpecials, "Arbonne Specials") { {
	Slate { "specials",	{
		_SafariStandards_,
		_SlateGlobals_,
		Event { "bonus", "" },			Click { 0, 255, 225, _window, _topLeft },
		Event { "monthly", "" },		Click { 0, 255, 266, _window, _topLeft },
		Event { "starter", "" },		Click { 0, 255, 307, _window, _topLeft },
		Event { "bronzer", "" },		Click { 0, 255, 348, _window, _topLeft },
		Event { "tote", "" },			Click { 0, 255, 389, _window, _topLeft },
		Event { "travel set", "" },		Click { 0, 255, 430, _window, _topLeft },
		Event { "host gift", "" },		Click { 0, 255, 471, _window, _topLeft },
		Event { "special products", "" },	Click { 0, 255, 512, _window, _topLeft },
		Event { "continue", "" },		Click { 0, 330, 555, _window, _topLeft },
		Event { "update", "" },			Click { 0, 455, 555, _window, _topLeft },
		Event { "complete", "" },		Click { 0, 590, 555, _window, _topLeft },
		ExitEvent { "exit", "" },		NilAction{},
		ExitEvent { "okay", "" },		Sequence{},
			Click { 1, 0, 0, _cursor },
			Click { 0, 475, 315, _window, _topLeft },
			endSequence{},
	 } }
} };
...
resource restype_Slate (resid_arbWebStats, "Arbonne WebStats Slate") { {
	Slate { "WebStats",	{
		...
		_CloseSubslate_,
		Event { "Browser", "" },			ResSubslate { resid_DocBrowser },
		Event { "Home", "" },				Click { 1, 85, 400, _window, _topRight },
		Event { "Orders", "" },				Sequence{},
			Click { 1, 85, 435, _window, _topLeft },
			ResSubslate { resid_arbwsOrders },
			endSequence{},
		Event { "Volume", "" },				Sequence{},
			Click { 1, 85, 485, _window, _topLeft },
			ResSubslate { resid_arbwsVolume },
			endSequence{},
		Event { "Clients", "" },			Click { 1, 85, 515, _window, _topLeft },
		Event { "Points", "" },				Click { 1, 85, 545, _window, _topLeft },
		Event { "Reports", "" },			Click { 1, 85, 575, _window, _topLeft },
		Event { "Commissions", "" },		Click { 1, 85, 605, _window, _topLeft },
		Event { "Profile", "" },			Click { 1, 85, 635, _window, _topLeft },
		Event { "Help", "" },				Click { 1, 85, 665, _window, _topLeft },
	 } }
} };
...
resource restype_Slate (resid_arbwsVolume, "Arbonne WebStats Volume") { {
	Slate { "Volume",	{
		_SafariStandards_,
		_CloseSubslate_,
		Event { "period", "" },		Click { 2, 255, 500, _window, _topLeft },
		Event { "search", "" },		Click { 1, 510, 500, _window, _topLeft },
		Event { "current", "" },	Click { 1, 290, 560, _window, _topLeft },
		Event { "history", "" },	Click { 1, 330, 560, _window, _topLeft },
		Event { "roster", "" },		Click { 1, 370, 560, _window, _topLeft },
		Event { "item", "" },		Click { 0, 25, 80, _window, _topLeft },
		Event { "rest ???", "" },	NilAction{},
		Event { "name", "" },		Click { 0, 327, 80, _window, _topLeft },
		Event { "volume", "" },		Click { 0, 455, 80, _window, _topLeft },
...
resource restype_Slate (resid_arbwsOrders, "Arbonne WebStats Orders") { {
	Slate { "Orders",	{
		_SafariStandards_,
		_CloseSubslate_,
		Event { "transaction", "" },	Click { 0, 300, 550, _window, _topLeft },
	 } }
} };
...
resource restype_Slate (resid_sudokuPost, "") { {
	Slate { "Post", {
		Event { "main frame", "" },		Click { 1, 300, 500, _window, _topLeft },
	...
	Slate { "Daily", {
		...
		Event { "index", "" },			Subslate { "year" },
			...
			ExitEvent { "ten", "" },		Subslate { "month"},
				...
				endSubslate{},
			ExitEvent { "eleven", "" },		Subslate { "month"},
				_SlateGlobals_,
				ExitEvent { "cancel", "" },		NilAction{},
				ExitEvent { "January", "" },	_indexStart_"11/01/index.html" }, endSequence{},
				ExitEvent { "February", "" },	_indexStart_"11/02/index.html" }, endSequence{},
				ExitEvent { "March", "" },		_indexStart_"11/03/index.html" }, endSequence{},
				ExitEvent { "April", "" },		_indexStart_"11/04/index.html" }, endSequence{},
				ExitEvent { "May", "" },		_indexStart_"11/05/index.html" }, endSequence{},
				ExitEvent { "June", "" },		_indexStart_"11/06/index.html" }, endSequence{},
				ExitEvent { "July", "" },		_indexStart_"11/07/index.html" }, endSequence{},
				ExitEvent { "August", "" },		_indexStart_"11/08/index.html" }, endSequence{},
				ExitEvent { "September", "" },	_indexStart_"11/09/index.html" }, endSequence{},
				ExitEvent { "October", "" },	_indexStart_"11/10/index.html" }, endSequence{},
				ExitEvent { "November", "" },	_indexStart_"11/11/index.html" }, endSequence{},
				ExitEvent { "December", "" },	_indexStart_"11/12/index.html" }, endSequence{},
				endSubslate{},
			ExitEvent { "twelve", "" },		Subslate { "month"},
				_SlateGlobals_,
				ExitEvent { "cancel", "" },		NilAction{},
				ExitEvent { "January", "" },	_indexStart_"12/01/index.html" }, endSequence{},
				ExitEvent { "February", "" },	_indexStart_"12/02/index.html" }, endSequence{},
				ExitEvent { "March", "" },		_indexStart_"12/03/index.html" }, endSequence{},
				ExitEvent { "April", "" },		_indexStart_"12/04/index.html" }, endSequence{},
				ExitEvent { "May", "" },		_indexStart_"12/05/index.html" }, endSequence{},
				ExitEvent { "June", "" },		_indexStart_"12/06/index.html" }, endSequence{},
				ExitEvent { "July", "" },		_indexStart_"12/07/index.html" }, endSequence{},
				ExitEvent { "August", "" },		_indexStart_"12/08/index.html" }, endSequence{},
				ExitEvent { "September", "" },	_indexStart_"12/09/index.html" }, endSequence{},
				ExitEvent { "October", "" },	_indexStart_"12/10/index.html" }, endSequence{},
				ExitEvent { "November", "" },	_indexStart_"12/11/index.html" }, endSequence{},
				ExitEvent { "December", "" },	_indexStart_"12/12/index.html" }, endSequence{},
				endSubslate{},
			ExitEvent { "thirteen", "" },	Subslate { "month"},
				_SlateGlobals_,
				ExitEvent { "cancel", "" },		NilAction{},
				ExitEvent { "January", "" },	_indexStart_"13/01/index.html" }, endSequence{},
				ExitEvent { "February", "" },	_indexStart_"13/02/index.html" }, endSequence{},
				ExitEvent { "March", "" },		_indexStart_"13/03/index.html" }, endSequence{},
				ExitEvent { "April", "" },		_indexStart_"13/04/index.html" }, endSequence{},
				ExitEvent { "May", "" },		_indexStart_"13/05/index.html" }, endSequence{},
				ExitEvent { "June", "" },		_indexStart_"13/06/index.html" }, endSequence{},
				ExitEvent { "July", "" },		_indexStart_"13/07/index.html" }, endSequence{},
				ExitEvent { "August", "" },		_indexStart_"13/08/index.html" }, endSequence{},
				ExitEvent { "September", "" },	_indexStart_"13/09/index.html" }, endSequence{},
				ExitEvent { "October", "" },	_indexStart_"13/10/index.html" }, endSequence{},
				ExitEvent { "November", "" },	_indexStart_"13/11/index.html" }, endSequence{},
				ExitEvent { "December", "" },	_indexStart_"13/12/index.html" }, endSequence{},
				endSubslate{},
			endSubslate{},
...
resource restype_Slate (resid_Safari, "Safari Slate") { {
	Slate { "Safari",	{
		...
		Event { "close tab", "" },			Sequence{}, ClickMenu { "File" }, TypeText { "Close Tab" }, _return, endSequence{},
		...
		Event { "go site", "" },			Subslate { "site" },
			...
			Event { "GitHub", "" },			OpenURL { "http://www.github.com/carolclark?tab=repositories" },
			Event { "Xcode", "" },			Sequence{}, OpenURL { "http://carol-clarks-imac.local/xcode" }, endSequence{},
			Event { "big screen", "" },		OpenURL { "http://carol-clarks-imac.local/xcode/bigscreen" },
			Event { "yahoo home", "" },		Sequence{},
				OpenURL { "http://my.yahoo.com/" }, ResSubslate { resid_YahooHome }, endSequence{},
			Event { "local home", "" },	Sequence{}, 
				OpenURL { "file:///Users/carolclark/Library/CCDev/Sites/Personal/index.html" }, endSequence{},
			...
			Event { "my development", "" },	Sequence{}, 
				OpenURL { "file:///Users/carolclark/Library/CCDev/Sites/TechnicalDocs/Support/Development.html" }, ResSubslate { resid_DocBrowser }, endSequence{},
		...
		Event { "Documentation", "" },		Click { 1, 65, 65, _window, _topLeft },
