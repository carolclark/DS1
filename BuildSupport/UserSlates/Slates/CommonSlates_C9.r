...
#pragma mark Launch
	resource restype_Slate (resid_LaunchSlate, "Launch Slate") { {
		Slate { "Launch",	{
			...
			Event { "Accessor", "launch Accessor" }, Launch { HomeApps_"Accessor.app", resid_DefaultSlate },
			Event { "System Prefs", "" }, Launch { Apps_"System Preferences.app", resid_SystemPrefs },
			Event { "Software Update", "launch Software Update" }, Launch { "/System/Library/CoreServices/Software Update.app", resid_DefaultSlate },
			Event { "Safari", "launch Safari" }, Launch { Apps_"Safari.app", resid_Safari },
			Event { "Mail", "launch Mail" }, Launch { Apps_"Mail.app", resid_Mail },
			Event { "Address Book", "launch Address Book" }, Launch { Apps_"Address Book.app", resid_DefaultSlate },
			Event { "Calendar", "launch iCal" }, Launch { Apps_"iCal.app", resid_Calendar },
			...
			Event { "Interface", "launch PreFab¨ UI Browser" }, Launch { MainApps_"UI Browser.app", resid_UIBrowser },
			...
			Event { "Arbonne", "launch Arbonne" }, Launch { Home_"Documents/Arbonne/Arbonne.numbers", resid_Numbers },
			...
			Event { "Package Maker", "launch PackageMaker" }, Launch { DevApps_"Utilities/PackageMaker.app", resid_DefaultSlate },
