...
resource restype_Slate (resid_Assert, "") { {
	Slate { "Assert",	{
		...
		ExitEvent { "equal strings", "" },	Sequence{}, TypeText { "_AssertEqualStrings_(<#str1#>,<#str2#>)" }, _previous, _previous, endSequence{},
...
resource restype_Slate (resid_InsertTag, "HTML tag") { {
	Slate { "tag",	{
		...
		ExitEvent { "table row", "", },  Sequence{}, TypeText { "<tr> ￼</tr>" }, _previous, endSequence{},
		ExitEvent { "table data", "", },  Sequence{}, TypeText { "<td>￼</td> " }, _previous, endSequence{},
		ExitEvent { "centered data", "", },  Sequence{}, TypeText { "<td align='center'>￼</td> " }, _previous, endSequence{},
		...
		ExitEvent { "dictionary item", "", },  Sequence{}, TypeText { "<dt>￼</dt><dd>￼</dd>" }, Keypress { kc_left, mf_command }, _previous, endSequence{},
		...
		ExitEvent { "link", "" }, Sequence{}, TypeText { "<a href=\"￼\">￼</a>" }, _previous, endSequence{},
		ExitEvent { "identifier", "" }, Sequence{}, _left, TypeText { " id=''" }, _left, endSequence{},
		ExitEvent { "glossary link", "" }, Sequence{}, TypeText { "<a class='glosslink' href=\"￼_gloss.html#def_￼\">￼</a>" }, _previous, _previous, _previous, endSequence{},
		ExitEvent { "refactor link", "" }, Sequence{}, TypeText { "<a href=\"../Support/DevelopingProjects.html#￼\">￼</a>" }, _previous, endSequence{},
