// =================================================================================
//	Developer_C9.r					(c)2013 C & C Software, Inc. All rights reserved.
// =================================================================================
...
resource restype_Slate (resid_Assert, "") { {
	Slate { "Assert",	{
		...
		ExitEvent { "verify", "" },			TypeText { "XC5TAssertTrue ([verifier verify], [verifier message]);" },
	} }
} };
...
resource restype_Slate (resid_InsertTag, "HTML tag") { {
	Slate { "tag",	{
		...
		ExitEvent { "refactor link", "" }, Sequence{}, TypeText { "<a href=\"../Support/DevelopingProjects.html#<#linkName#>\"><#content#></a>" }, _previousField, endSequence{},
