...
resource restype_Slate (resid_Arbonne, "") { {
	Slate { "Arbonne",	{
		...
		Event { "Sheet", "" },			Subslate { "Sheet" },
			...
			ExitEvent { "Invoices", "" },		Click { 1, 80, 298, _window, _topLeft },
			ExitEvent { "Items Ordered", "" },	Click { 1, 80, 348, _window, _topLeft },
			ExitEvent { "People", "" },			Click { 1, 80, 398, _window, _topLeft },
			ExitEvent { "Products", "" },		Click { 1, 80, 448, _window, _topLeft },
			ExitEvent { "View Invoice", "" },	Click { 1, 80, 523, _window, _topLeft },
			endSubslate{},
		Event { "Table", "" },			Subslate { "Table" },
			...
			ExitEvent { "Invoice Data", "" },		Sequence{}, Click { 1, 190, 658, _window, _topLeft }, Click { 1, 160, 658, _window, _topLeft }, endSequence{},
			ExitEvent { "Invoices", "" },			Sequence{}, Click { 1, 190, 164, _window, _topLeft }, Click { 1, 160, 164, _window, _topLeft }, endSequence{},
			ExitEvent { "Items Ordered", "" },		Sequence{}, Click { 1, 190, 183, _window, _topLeft }, Click { 1, 160, 183, _window, _topLeft }, endSequence{},
			ExitEvent { "Invoice Info", "" },		Click { 1, 896, 153, _window, _topLeft }, Click { 1, 160, 183, _window, _topLeft }, endSequence{},
			endSubslate{},
