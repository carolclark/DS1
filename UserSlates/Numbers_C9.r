...
resource restype_Slate (resid_Arbonne, "") { {
	Slate { "Arbonne",	{
		...
		Event { "append row", "" },		Sequence{}, Keypress { kc_pagedown, 0 }, Click { 1, 190, -22, _window, _bottomLeft }, Click { 1, 160, -22, _window, _bottomLeft }, Keypress { kc_down, mf_option }, endSequence{},
