...
resource restype_Slate (resid_SystemPrefs, "SystemPrefs Slate") { {
	Slate { "SystemPrefs",	{
		...
		Event { "Spaces", "" },				Sequence{}, Keypress { kc_F, mf_command }, TypeText { "Spaces" }, _return, endSequence{},
		...
		Event { "Accounts", "" },			Sequence{}, Keypress { kc_F, mf_command }, TypeText { "Accounts" }, _return, endSequence{},
