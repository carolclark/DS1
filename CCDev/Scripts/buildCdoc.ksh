...
buildsource_Cdoc=(sourceDirectory="${HOME}/Dev/${project}/Cdoc" destinationDirectory="${CCDev}/Sites/TechnicalDocs/${project}" derivedDirectory="${CCDev}/build/${project}/Cdoc" subtarget="")
